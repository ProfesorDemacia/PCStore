...
//         conec.setNombreBaseDatos("jdbc:mysql://sql9.freemysqlhosting.net/sql9593091");
//         conec.setNombreTabla("usuario");
//         conec.setCadenaConexion("com.mysql.jdbc.Driver");
//         conec.setUsuario("sql9593091");
//         conec.setPass("8wMheHhQXy");
//         conec.setCadenaSQL("SELECT * FROM usuario;");
